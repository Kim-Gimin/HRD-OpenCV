...
void drawPolys(){
	cv::Mat img(400, 400, CV_8UC4, cv::Scalar(255, 255, 255));
	...
	cv::putText(img, "I Will Find You And I Will Kill You", cv::Point(20, 50), cv::FONT_HERSHEY_COMPLEX, 1, cv::Scalar(0, 0, 255));
